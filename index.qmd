...
# ── Legend (surgeons only) ─────────────────────────────────────────────────────
legend_dreamy = mlines.Line2D([], [], color=dreamy_color, marker=dreamy_marker,
                               linestyle='None', markersize=8, label='Doc Dreamy')
legend_duck   = mlines.Line2D([], [], color=duck_color, marker=duck_marker,
                               linestyle='None', markersize=8, label='Doc Duck')
ax.legend(handles=[legend_dreamy, legend_duck], title='Surgeon', frameon=True, fontsize=10)
...
# ── Shaded overlay (-1 to 1 severity) — no legend entry ───────────────────────
...
# ── Legend (surgeons only, no shaded region) ───────────────────────────────────
legend_dreamy = mlines.Line2D([], [], color=dreamy_color, marker=dreamy_marker,
                               linestyle='None', markersize=8, label='Doc Dreamy')
legend_duck   = mlines.Line2D([], [], color=duck_color, marker=duck_marker,
                               linestyle='None', markersize=8, label='Doc Duck')
ax.legend(handles=[legend_dreamy, legend_duck], title='Surgeon',
